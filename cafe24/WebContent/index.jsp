		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><button id="myInfoBtn" class="navbarBtn btn btn-default" onclick ="location.href='./member/myInfo.jsp?id=<%=(String)session.getAttribute("s_id")%>'">내정보</button></li>
					<%
						}
					%>
				</ul>
					...
					<table class="table" style="width:500px;">
						...
						<tr>			
							<td colspan="2">
								...
								<span><a href="./member/findAccount.jsp">아이디/</a></span>
								<span><a href="./member/findPasswd.jsp">비밀번호 찾기</a></span>								
							</td>
						</tr>
						<tr>
							<td colspan="2">
